export const FOODS = [
  ...
  { id: "pain-epeautre-industriel", nom: "Pain d'Épeautre industriel (levure)", cat: "Féculents", midi: "red", soir: "red", note: "2/10", fodmap: "Fructanes non prédigérés.", contrainte: "À éviter", tags: [] },
  { id: "frites", nom: "Frites", cat: "Féculents", midi: "red", soir: "red", note: "1/10", fodmap: "Graisses saturées, saboteur du sommeil.", contrainte: "À éviter", tags: ["saboteur"] },
  ...
  { id: "mais", nom: "Maïs", cat: "Légumes", midi: "red", soir: "red", note: "2/10", fodmap: "Sorbitol élevé, fermente vite.", contrainte: "À éviter", tags: [] },
  ...
  { id: "banane-mure", nom: "Banane mûre (taches noires)", cat: "Fruits", midi: "red", soir: "red", note: "2/10", fodmap: "Bombe à fructanes.", contrainte: "À éviter", tags: ["liste noire"] },
  ...
  { id: "mangue", nom: "Mangue", cat: "Fruits", midi: "red", soir: "red", note: "2/10", fodmap: "Fructose élevé. Perturbe le sommeil.", contrainte: "À éviter", tags: ["liste noire"] },
  ...
  { id: "speculoos", nom: "Spéculoos", cat: "Fruits", midi: "red", soir: "red", note: "1/10", fodmap: "Sucre + blé.", contrainte: "À éviter", tags: ["saboteur"] },
  ...
  { id: "oignon", nom: "Oignon", cat: "Condiments", midi: "red", soir: "red", note: "0/10", fodmap: "Ennemi public n°1 du SIBO.", contrainte: "À bannir", tags: ["liste noire"] },
  { id: "echalote", nom: "Échalote", cat: "Condiments", midi: "red", soir: "red", note: "0/10", fodmap: "Même famille que l'oignon.", contrainte: "À bannir", tags: ["liste noire"] },
  ...
  { id: "ketchup", nom: "Ketchup", cat: "Condiments", midi: "red", soir: "red", note: "2/10", fodmap: "Sucre + oignon souvent.", contrainte: "À éviter", tags: [] },
